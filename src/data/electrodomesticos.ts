...
export const ELECTRODOMESTICOS: Electrodomestico[] = [
  ...
  },
  {
    ...
    sintomas: [
      ...
      'Pierde agua por la puerta o por debajo',
      'Hace ruido excesivo al lavar o al secar',
      'No enciende o se queda bloqueada',
      'Muestra códigos de error en el display',
      'El tambor no gira durante el lavado',
      'El secado deja la ropa húmeda',
      'Se para sola a mitad del programa',
    ],
    marcas: ['Siemens', 'Bosch', 'Balay', 'Miele', 'AEG', 'Electrolux', 'LG', 'Samsung', 'Beko', 'Zanussi', 'Fagor'],
    faq: [
      {
      ...
      },
      {
        ...
        a: 'Depende de la antigüedad y la avería. Una lavasecadora de menos de 8 años generalmente merece la pena reparar. Te damos un presupuesto honesto y si no es rentable económicamente, te lo decimos claramente.',
      },
      {
        q: '¿Reparáis lavasecadoras Siemens, Bosch y Balay en Pamplona?',
        a: 'Sí, somos especialistas en lavasecadoras Siemens, Bosch y Balay, las marcas más vendidas en Navarra. También reparamos LG, Samsung, Miele, AEG, Beko, Fagor y cualquier otra marca.',
      },
    ],
    imgAlt: 'Técnico reparando lavasecadora en Pamplona',
    heroImg: '/lavadora.webp',
  },
  {
    slug: 'congelador',
    nombre: 'Congelador',
    nombrePlural: 'Congeladores',
    ...
    sintomas: [
      ...
      'El motor trabaja continuamente sin parar',
      'Hace ruido excesivo o intermitente',
      'Gotea agua dentro o por debajo',
      'El display muestra un error o parpadea',
      'La puerta no cierra bien o la junta está dañada',
      'El congelador se descongela solo',
      'La temperatura no baja de -10 °C',
    ...
    faq: [
      ...
      },
      {
        ...
        a: 'Sí, reparamos congeladores verticales, arcones horizontales y congeladores bajo encimera de todas las marcas y capacidades.',
      },
      {
        q: '¿Qué hago si el congelador ha dejado de funcionar y tengo alimentos dentro?',
        a: 'No abras la puerta más de lo necesario. Un congelador bien cerrado mantiene la temperatura unas 24-48 horas. Llámanos de inmediato para que podamos priorizar la visita y minimizar las pérdidas.',
      },
    ],
    imgAlt: 'Técnico reparando congelador en Pamplona',
  },
  {
    slug: 'termo-electrico',
    nombre: 'Termo eléctrico',
    nombrePlural: 'Termos eléctricos',
    ...
    sintomas: [
      ...
      'Pierde agua por la válvula de seguridad',
      'Hay goteras o humedad en la pared cerca del termo',
      'El piloto luminoso no enciende',
      'El agua sale con mal olor (a huevo podrido)',
      'La resistencia eléctrica está quemada',
      'El termostato no regula bien la temperatura',
      'El termo consume mucho pero no calienta',
      'Hace ruido al calentar (chasquidos, borboteos)',
    ],
    marcas: ['Fleck', 'Ariston', 'Thermor', 'Cointra', 'Junkers', 'Fagor', 'Siemens', 'Bosch', 'Balay', 'Cointra', 'Ferroli'],
    faq: [
      {
      ...
      },
      {
        ...
        a: 'Un termo de menos de 8-10 años generalmente merece la pena reparar. Si el depósito está corroído o tiene fugas internas, la sustitución es más económica. Te damos un presupuesto honesto y te recomendamos la mejor opción.',
      },
      {
        q: '¿Por qué el agua del termo huele mal?',
        a: 'El mal olor (a huevo podrido) suele indicar que el ánodo de magnesio está agotado y hay proliferación de bacterias en el depósito. Se soluciona cambiando el ánodo y desinfectando el interior. Es una reparación habitual que resolvemos en la primera visita.',
      },
    ],
    imgAlt: 'Técnico reparando termo eléctrico en Pamplona',
  },
]
